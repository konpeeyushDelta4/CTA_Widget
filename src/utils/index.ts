export type WidgetTemplate = 'telegram' | 'whatsapp';
...
/**
 * Generates the integration script based on the selected template type and contact information
 */
export function generateWidgetScript(template: WidgetTemplate, contactInfo: ContactInfo) {
    // Default values if not provided
    const telegramUsername = contactInfo?.telegramUsername || 'yourcompany';
    const whatsappNumber = contactInfo?.whatsappNumber || '1234567890';
...
<script>
(function() {
  // Configuration - Replace with your Telegram username if needed
  ...
  subtitle.textContent = 'Company Support';
...
<script>
(function() {
  // Configuration - WhatsApp number
  var whatsappNumber = "${whatsappNumber}";
  var welcomeMessage = 'Hello! I have a question about your services.';
  ...
  messageText.textContent = 'Greetings! And Welcome To Company Name! How May We Assist You Today?';
  initialMessage.appendChild(messageText);
  chatBody.appendChild(initialMessage);
  ...
  startChatBtn.addEventListener('click', function() {
    var url = 'https://wa.me/' + whatsappNumber + '?text=' + encodeURIComponent(welcomeMessage);
